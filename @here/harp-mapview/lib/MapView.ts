...
export interface MapViewOptions extends TextElementsRendererOptions, Partial<LookAtParams> {
    ...
    /**
     * Optional [[ElevationProvider]] where [[DataSource]]s create geometry above and/or below
     * ground level.
     */
...
export class MapView extends EventDispatcher {
    ...
    constructor(options: MapViewOptions) {
        ...
        if (this.m_options.elevationRangeSource !== undefined) {
            this.m_elevationRangeSource = this.m_options.elevationRangeSource;
        }
